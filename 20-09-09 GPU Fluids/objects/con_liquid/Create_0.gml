...
isScalar = shader_get_uniform(shd_advection,"isScalar");
isSource = shader_get_uniform(shd_advection,"isSource");
fluidSource = false;
//Viscous Diffusion
...
isUnsigned = shader_get_uniform(shd_visualize,"unsigned");

//gaussian splat

pt = shader_get_uniform(shd_addMaterial,"point");
r = shader_get_uniform(shd_addMaterial,"radius");
fC = shader_get_uniform(shd_addMaterial,"fillColor");

//velocity splat
vpt = shader_get_uniform(shd_addForce, "point");
vr	= shader_get_uniform(shd_addForce,"radius");
vfC = shader_get_uniform(shd_addForce,"fillColor");
