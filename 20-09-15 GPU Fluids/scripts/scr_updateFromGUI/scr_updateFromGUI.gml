...
con_liquid.buoyancyAlpha = buoyancyAlpha.returnValue;
con_liquid.buoyancyBeta = buoyancyBeta.returnValue;

con_liquid.size = size.returnValue;
con_liquid.scale = scale.returnValue;
