...
//uniform float dissipation;
	...
	uniform vec2 texelSize; //z: texel_size.x, w: texel_size.y
	uniform bool useMac; //true
	uniform vec2 dissipationValues;// x: velocity_dissipation_type, y: velocity_dissipation_value,
	uniform float macWeight; //x: mac_weight * 0.5;
