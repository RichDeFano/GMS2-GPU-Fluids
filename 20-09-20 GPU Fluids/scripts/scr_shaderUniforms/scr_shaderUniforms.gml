...
texSize = shader_get_uniform(shd_advection,"texelSize");
useMac = shader_get_uniform(shd_advection,"useMac");
adDiss = shader_get_uniform(shd_advection,"dissipationValues");
macW = shader_get_uniform(shd_advection,"macWeight");
